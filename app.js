...
rl.on('line',lineString =>{
    ...
    // 年代を取得
    const generationName = getGenerationName(ageId);
    // 現時点での年代の人口を取得
...
rl.on('close',() => {
    // 年代が多い順にソートする
    const sortedGenerationPopulationMap = Array.from(generationPopulationMap).sort((pair1, pair2) => {
...
function getGenerationName(ageId) {
